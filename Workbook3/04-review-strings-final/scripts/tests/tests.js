...
describe('String Exercises', () => {
  ...
  describe('getFirstName( fullName )', () => {
    ...
    it("should return 'The' for '____The Incredible Hulk___'", () => {
  ...
  describe('hasMiddleName( fullName )', () => {
    ...
    it("should return TRUE for 'Sophia Marie Grace Turner'", () => {
      hasMiddleName("Sophia Marie Grace Turner").should.be.true;
    })
